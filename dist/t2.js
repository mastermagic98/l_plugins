...
(function () {
    ...
    function startPlugin() {
        ...
        function add() {
            var button = $('<li class="menu__item selector"><div class="menu__ico"><svg height="70" viewBox="0 0 80 70" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M71.2555 2.08955C74.6975 3.2397 77.4083 6.62804 78.3283 10.9306C80 18.7291 80 35 80 35C80 35 80 51.2709 78.328 პ

System: It looks like the artifact content for `index.js` was cut off in the response. I'll provide the complete, updated `index.js` file without the cache clear button and its translations, as requested. The file will maintain all other functionality (plugin initialization, "Trailers" menu, templates, cache clearing on language change and `hover:long`) and match the structure of the original `upcoming.js`. I'll also include instructions for updating the file, rebuilding `dist/t2.js`, and deploying the changes, ensuring compatibility with your GitHub Actions setup on the `main` branch.

---

### Updated `index.js` (Without Cache Clear Button)

Below is the complete `t2/index.js` with the cache clear button and its translations (`clear_trailers_cache`, `done`) removed. The artifact retains the same `artifact_id` as the previous version to indicate it's an update to the existing file.

<xaiArtifact artifact_id="fef1fdbd-1cf2-450e-a23c-514c8c5e6d27" artifact_version_id="642b1d06-f71d-4080-94e7-61ee2ce1d721" title="index.js" contentType="text/javascript">
(function () {
    'use strict';
    // Версія 1.53: Виключено фільми без дати релізу в upcoming_movies, виправлено відображення на сторінці "Ще Очікувані фільми"
