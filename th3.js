(function () {
    ...
    Lampa.Lang.add({
        ...
        icon_focus_color: {
            ru: 'Цвет иконок при фокусе',
            en: 'Icons focus color',
            uk: 'Колір іконок при фокусі'
        },
    ...
    function applyStyles() {
        ...
        style.innerHTML = (
            ':root {' +
                ...
                '--icon-focus-color: ' + ColorPlugin.settings.icon_focus_color + ';' +
            '}' +
            '.menu__ico {' +
                'color: ' + ColorPlugin.settings.icon_color + ' !important;' +
            '}' +
            '.menu__item.focus .menu__ico {' +
                'color: ' + ColorPlugin.settings.icon_focus_color + ' !important;' +
            '}' +
        ...
        updatePluginIcon();
        console.log('ColorPlugin: Applied styles, icon_color: ' + ColorPlugin.settings.icon_color + ', icon_focus_color: ' + ColorPlugin.settings.icon_focus_color + ', main_color: ' + ColorPlugin.settings.main_color);
    }
    ...
    function openColorPicker(paramName, colors, title) {
        ...
        var hexValue = Lampa.Storage.get('color_plugin_custom_hex_' + paramName, '') || '#000000';
                ...
                onSelect: function (a) {
                    if (a.length > 0 && a[0] instanceof HTMLElement) {
                        ...
                        if (selectedElement.classList.contains('hex-input')) {
                            ...
                            Lampa.Modal.close();
                            var inputOptions = {
                                name: 'color_plugin_custom_hex_' + paramName,
                                value: Lampa.Storage.get('color_plugin_custom_hex_' + paramName, ''),
                            ...
                            Lampa.Input.edit(inputOptions, function (value) {
                                ...
                                Lampa.Storage.set('color_plugin_custom_hex_' + paramName, value);
    ...
    function initPlugin() {
        ...
        ColorPlugin.settings.icon_focus_color = Lampa.Storage.get('color_plugin_icon_focus_color', '#497d00');
        ...
        if (Lampa.SettingsApi) {
            ...
            // Колір іконок при фокусі
            Lampa.SettingsApi.addParam({
                component: 'color_plugin',
                param: {
                    name: 'color_plugin_icon_focus_color',
                    type: 'button'
                },
                field: {
                    name: Lampa.Lang.translate('icon_focus_color')
                },
                onChange: function () {
                    openColorPicker('icon_focus_color', ColorPlugin.colors.icon_focus, 'icon_focus_color');
                }
            });
