(function () {
    'use strict';
    // Версія 1.12 Повернуто розмір карток на trailers_full до 25.7em, як у картки ЩЕ та попередніх версій. Збережено підвантаження карток, дебонсинг, виправлення SyntaxError у Trailer, однакову поведінку кнопки та картки ЩЕ. Використано end_ratio: 2. Мова JavaScript ES5
