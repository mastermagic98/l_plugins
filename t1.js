(function () {
    'use strict';
    // Версія 1.0.5: Виправлено логіку вибору трейлерів, обмежено до userLang/ua або en, прибрано інші мови. Збережено стабільність та стиль.
                    ...
                    Api.videos(data, function (videos) {
                        ...
                        if (trailers.length) {
                            ...
                            trailers.forEach(function (video) {
                                if (video.key && (video.iso_639_1 === userLang || (userLang === 'uk' && video.iso_639_1 === 'ua') || video.iso_639_1 === 'en')) {
                                    items.push({
