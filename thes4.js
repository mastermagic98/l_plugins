/*Є ще баги
1) ліворуч  в меню Лампа при фокусування ікноки змінюють свій колір на протилежний, не потрбіно, щоб міняли як текст поряд. Аналогічна поведінка іконок в шапці лампи
2)дуже світле меню мабуть необхідно включити тип фону - чорний
За замовчування встанови Тему Лампа, і коли вона ввімкнена, то кнопку Колір теми приховай */
(function () {
  'use strict';
  ...
  (function () {
    ...
    function initializeThemeManager() {
      ...
      var ThemeSettings = {
        name: 'custom_themes',
        settings: {
          enabled: Lampa.Storage.get('custom_themes_enabled', true),
          theme: Lampa.Storage.get('custom_themes_theme', 'custom_color'),
      ...
      function applySavedTheme() {
        if (!ThemeSettings.settings.enabled) return;
