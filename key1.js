(function () {
    ...
    // === Додаємо пункт у меню Налаштування ===
    ...
    // === Примусове встановлення мови при запуску клавіатури ===
    ...
    // ——— Синхронізація при запуску сторінок Lampa ———
