(function () {
    ...
    sources: function () {
      ...
      Lampa.Modal.render().find('.cub-premium__descr:eq(1)').text('У вас осталось ' + leftVipD + ' дней');
	  ...
	  rating_kp_imdb:function (card) {
        ...
        Pub.network.clear();
          ...
          var kp_rating = !isNaN(kp) && kp !== null ? parseFloat(kp).toFixed(1) : '0.0';
  			  ...
  			  user_id: user_id, 
  			  uid: uid,
  			  ips: '2a01:c23:912d:e600:cd34:780e:d826:860f',
          id: 'undefined',
          auth: logged
  			});
			});
...
interfaceElement.after(settingsElement);
        ...
        Lampa.SettingsApi.addParam({
          ...
          field: {
            name: '<span style="color:#ffda00">Не вошли в аккаунт или не верный email</span><br> 💻 Windows NT 10.0 (x64)'
          }
        });
      ...
      Filmix.network["native"](u, function (j) {
		...
		function gtag() {
			var idl = '2a01:c23:912d:e600:cd34:780e:d826:860f';
