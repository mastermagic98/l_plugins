ВСЕ ПРАЦЮЄ ВІДМІННО.
А тепер на базі цього коду будемо робити зміни:
1) плагін виведемо як окремий компонент панелі налаштування з іконкою;
2) стилі використовуй з файлів 
https://bylampa.github.io/themes/css/red_stroke.css
https://bylampa.github.io/themes/css/green_stroke.css
https://bylampa.github.io/themes/css/violet_stroke.css та інших, які зазначені в https://bylampa.github.io/themes/categories/stroke.json.

вони мають однаковий набір параметрів css, тому було вдало інтегрувати в код плагіну і додати функцію яка мінятиме колір
3) додати кнопку стиль лампа (яка вимикатиме плагін) і кнопка користувацька тема, яка його вмикатиме, а інше кнопка вибір кольору ( всі кнопки як підкомпонент плагіна)


 Нижче код, який містить базові кольорові теми, код іконки, назву плагіну. В жодному випадку з цього коду не виористовую стилі для виокристання в початковому коді 
     (function() {
    'use strict';
