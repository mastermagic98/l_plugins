...
🔹 [**Логотипи**](https://mastermagic98.github.io/l_plugins/upcoming.js) – трейлери

![Детально](https://mastermagic98.github.io/l_plugins/cat_ua.png)

## 📢 Останні оновлення
🔹 **v2.0 – Трейлери** (дата релізу: 2025-06-06) Плагін для платформи Lampa додає розділ із трейлерами, інтегруючись із API The Movie Database (TMDB). Він:
