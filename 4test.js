(function () {
    ...
    Lampa.SettingsApi.addParam({
        ...
        field: {
            name: 'Мои темы', // My Themes
            description: 'Измени палитру элементов приложения' // Change the palette of application elements
        },
    ...
    function ThemesComponent(params) {
        ...
        this.append = function (data) {
            data.forEach(item => {
                ...
                function addInstallButton() {
                    ...
                    button.innerText = 'Установить'; // Install
                    ...
                    Lampa.Select.show({
                        ...
                        onSelect: (selected) => {
                            if (selected.title === 'Установить') {
                                ...
                                console.log('Тема установлена:', item.css); // Theme installed
        ...
        this.selectGroup = function () {
            Lampa.Select.show({
                title: 'Категории тем', // Theme Categories
                items: categories,
                onSelect: (item) => {
                    Lampa.Activity.push({
                        url: item.url,
